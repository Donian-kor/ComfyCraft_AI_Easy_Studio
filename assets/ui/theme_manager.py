...
tools/generate_themes.py 로 생성됩니다.
...
THEME_DIR = UI_DIR / "themes"
LEGACY_QSS = UI_DIR / "style.qss"          # 이전 방식(단일 style.qss) 폴백용
SETTING_PATH = UI_DIR.parent.parent / "workflows" / "ui_theme.json"
